...
\end{itemize}
Seu programa deve receber uma matriz e a posição da peça inimiga que o Nathan quer capturar e responder \texttt{Sim} se é possível capturar essa peça com um movimento e \texttt{Nao} caso contrário. \\
